## Kron Metadata Specification

Additional fields may be added, but will be ignored by Kron.
...
```
{
   ...
   "contract_signature": "<Kron signed contract_hash>",
...
**forsale_price** - To give buyers an idea of the cost to own and admin the asset token.   Price followed by a space, followed by the currency.  Examples: "10000 ESS" or "0.3 BTC" or "50000 USD"  This might be parsed by token broker websites.
