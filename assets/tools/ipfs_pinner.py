...
mode = ""
rpc_port = 8766
#Set this information in your Kron.conf file (in datadir, not testnet3)
rpc_user = 'rpcuser'
rpc_pass = 'rpcpass555'
	...
	for i in range(start_block,blockheight):
	    ...
	    for tx in txs:
	        ...
	        for vout in tx_detail.get('vout'):
	            if (vout.get('scriptPubKey').get('asm')[86:98] == "OP_ESS_ASSET"):
	                print_debug("Found OP_ESS_ASSET")
