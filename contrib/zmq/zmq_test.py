...
"""
    ...
    Kron should be started with the command line arguments:
        Krond -testnet -daemon \
...
while True:
	...
	if topic == b"hashblock":
		...
		while(pos != -1):
			...
			if (pos > -1):
				print("FOUND ESS issuance at " + str(pos))
				print("After ESS: " + astr[pos+6:pos+8])
			...
			pos = astr.find('72766e', start)
			if (pos > -1):
				print("FOUND ESS something at " + str(pos))
			start += pos+8
			print(astr)
