...
Below are some notes on how to build Kron Core for Windows.
...
Building on Ubuntu Xenial 16.04 is known to be broken, see extensive discussion in issue [8732](https://github.com/KronProject/Kron/issues/8732).
...
to work around issues with mingw-w64. See issue [8732](https://github.com/KronProject/Kron/issues/8732) for more information.
```
...
way. This will install to `c:\workspace\Kron`, for example:

    make install DESTDIR=/mnt/c/workspace/Kron
