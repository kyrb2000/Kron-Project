Kron Core version *2.0.4.0* is now available!!
==============

  <https://github.com/KronProject/Kron/releases/tag/v2.0.4>
...
Changelog available here: <https://github.com/KronProject/Kron/commits/release_2.0.4>
