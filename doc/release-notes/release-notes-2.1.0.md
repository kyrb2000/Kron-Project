Kron Core version *2.1.0* is now available!!
==============

  <https://github.com/KronProject/Kron/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/KronProject/Kron/commits/release_2.1.0>
