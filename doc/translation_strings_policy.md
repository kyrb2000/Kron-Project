...
This document provides guidelines for internationalization of the Kron Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `Kron_en.ts` remains unchanged.
