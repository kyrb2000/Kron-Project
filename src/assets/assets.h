...
#ifndef Kron_ASSET_PROTOCOL_H
#define Kron_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_Kron_ASSET ESSQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_Kron_ASSET ESSO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_Kron_ASSET ESSR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_Kron_ASSET ESST
