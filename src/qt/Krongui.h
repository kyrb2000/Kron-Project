...
#ifndef Kron_QT_KronGUI_H
#define Kron_QT_KronGUI_H
...
/**
  Kron GUI main class. This class represents the main window of the Kron UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class KronGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit KronGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~KronGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a Kron wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
