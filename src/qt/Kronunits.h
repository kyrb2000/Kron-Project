...
#ifndef Kron_QT_KronUNITS_H
#define Kron_QT_KronUNITS_H
...
/** Kron unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class KronUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit KronUnits(QObject *parent);

    /** Kron units.
      @note Source: https://en.Kron.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        Kron,
...
typedef KronUnits::Unit KronUnit;

#endif // Kron_QT_KronUNITS_H
