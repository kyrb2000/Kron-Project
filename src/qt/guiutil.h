...
#ifndef Kron_QT_GUIUTIL_H
#define Kron_QT_GUIUTIL_H
...
/** Utility functions used by the Kron Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "Kron:" URI into recipient object, return true on successful parsing
