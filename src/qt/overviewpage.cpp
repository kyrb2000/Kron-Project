...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(KronUnits::Kron),
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(KronUnits::formatWithUnit(unit, balance, false, KronUnits::separatorAlways));
    ui->labelUnconfirmed->setText(KronUnits::formatWithUnit(unit, unconfirmedBalance, false, KronUnits::separatorAlways));
    ui->labelImmature->setText(KronUnits::formatWithUnit(unit, immatureBalance, false, KronUnits::separatorAlways));
    ui->labelTotal->setText(KronUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, KronUnits::separatorAlways));
    ui->labelWatchAvailable->setText(KronUnits::formatWithUnit(unit, watchOnlyBalance, false, KronUnits::separatorAlways));
    ui->labelWatchPending->setText(KronUnits::formatWithUnit(unit, watchUnconfBalance, false, KronUnits::separatorAlways));
    ui->labelWatchImmature->setText(KronUnits::formatWithUnit(unit, watchImmatureBalance, false, KronUnits::separatorAlways));
    ui->labelWatchTotal->setText(KronUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, KronUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("Kron")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the Kron balance grid from expanding and looking terrible when asset balance is hidden
