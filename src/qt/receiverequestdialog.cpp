...
#include "config/Kron-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatKronURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + KronUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatKronURI(info));
}
