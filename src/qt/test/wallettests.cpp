...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<KronAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_Kron-qt -platform xcb      # Linux
//     src/qt/test/test_Kron-qt -platform windows  # Windows
//     src/qt/test/test_Kron-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = KronUnits::formatWithUnit(unit, balance, false, KronUnits::separatorAlways);
    ...
    // Amount input
    KronAmountField* amountInput = receiveCoinsDialog.findChild<KronAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: Kron:")) != -1);
