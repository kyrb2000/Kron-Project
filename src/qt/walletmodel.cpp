...
WalletModel::SendCoinsReturn WalletModel::prepareTransaction(WalletModelTransaction &transaction, const CCoinControl& coinControl)
{
    ...
    for (const SendCoinsRecipient &rcp : recipients)
    {
        ...
        {   // User-entered Kron address / amount:
...
WalletModel::SendCoinsReturn WalletModel::sendCoins(WalletModelTransaction &transaction)
{
...

    {
        ...
        for (const SendCoinsRecipient &rcp : transaction.getRecipients())
        {
            ...
            else if (!rcp.message.isEmpty()) // Message from normal Kron:URI (Kron:123...?message=example)
...
//    questionString.append(KronUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), oldFee));
//    questionString.append("</td></tr><tr><td>");
//    questionString.append(tr("Increase:"));
//    questionString.append("</td><td>");
//    questionString.append(KronUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), newFee - oldFee));
//    questionString.append("</td></tr><tr><td>");
//    questionString.append(tr("New fee:"));
//    questionString.append("</td><td>");
//    questionString.append(KronUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), newFee));
