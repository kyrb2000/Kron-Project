...
void WalletView::setKronGUI(KronGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? KronGUI::HD44_ENABLED : _walletModel->hdEnabled() ? KronGUI::HD_ENABLED : KronGUI::HD_DISABLED);
