...
#ifndef Kron_SCRIPT_STANDARD_H
#define Kron_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_Kron_ASSET script that carries data
    /** ESS END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a Kron address
 */
...
/**
 * Generate a Kron scriptPubKey for the given CTxDestination. Returns a P2PKH
