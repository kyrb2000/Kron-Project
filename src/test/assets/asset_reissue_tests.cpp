...
BOOST_FIXTURE_TEST_SUITE(asset_reissue_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(reissue_cache_test_ipfs)
    {
        ...
        CNewAsset asset1("ESSASSET", CAmount(100 * COIN), 8, 1, 0, "");
        ...
        CReissueAsset reissue1("ESSASSET", CAmount(1 * COIN), 8, 1, DecodeAssetData("QmacSRmrkVmvJfbCpmU6pK72furJ8E8fbKHindrLxmYMQo"));
        ...
        BOOST_CHECK_MESSAGE(cache.mapReissuedAssetData.count("ESSASSET"), "Map Reissued Asset should contain the asset \"ESSASSET\"");
        BOOST_CHECK_MESSAGE(cache.mapAssetsAddressAmount.at(make_pair("ESSASSET", GetParams().GlobalBurnAddress())) == CAmount(101 * COIN), "Reissued amount wasn't added to the previous total");

        // Get the new asset data from the cache
        CNewAsset asset2;
        BOOST_CHECK_MESSAGE(cache.GetAssetMetaDataIfExists("ESSASSET", asset2), "Failed to get the asset2");
        ...
        BOOST_CHECK_MESSAGE(asset2.strName == "ESSASSET", "Asset2: Asset name is wrong");
        ...
        undoBlockData.emplace_back(std::make_pair("ESSASSET", CBlockAssetUndo{true, false, "", 0, ASSET_UNDO_INCLUDES_VERIFIER_STRING, false, ""}));
        ...
        CNewAsset asset3;
        BOOST_CHECK_MESSAGE(cache.GetAssetMetaDataIfExists("ESSASSET", asset3), "Failed to get the asset3");
        ...
        BOOST_CHECK_MESSAGE(asset3.strName == "ESSASSET", "Asset3: Asset name is wrong");
        ...
        BOOST_CHECK_MESSAGE(cache.mapReissuedAssetData.count("ESSASSET"), "Map of reissued data was removed, even though changes were made and not databased yet");
        BOOST_CHECK_MESSAGE(cache.mapAssetsAddressAmount.at(make_pair("ESSASSET", GetParams().GlobalBurnAddress())) == CAmount(100 * COIN), "Assets total wasn't undone when reissuance was");
    }
    ...
    BOOST_AUTO_TEST_CASE(reissue_cache_test_txid)
    {
        ...
        // Create a reissuance of the asset
        CReissueAsset reissue1("ESSASSET", CAmount(1 * COIN), 8, 1, DecodeAssetData("9c2c8e121a0139ba39bffd3ca97267bca9d4c0c1e84ac0c34a883c28e7a912ca"));
        COutPoint out(uint256S("BF50CB9A63BE0019171456252989A459A7D0A5F494735278290079D22AB704A4"), 1);
    ...
    BOOST_AUTO_TEST_CASE(reissue_isvalid_test)
    {
        ...
        CReissueAsset reissue3("ESSASSET", CAmount(1 * COIN), 7, 1, DecodeAssetData("QmacSRmrkVmvJfbCpmU6pK72furJ8E8fbKHindrLxmYMQo"));
        ...
        CReissueAsset reissue4("ESSASSET", CAmount(1 * COIN), -1, 1, DecodeAssetData("QmacSRmrkVmvJfbCpmU6pK72furJ8E8fbKHindrLxmYMQo"));
        ...
        CNewAsset asset2("ESSASSET2", CAmount(100 * COIN), 0, 1, 0, "");
        ...
        CReissueAsset reissue5("ESSASSET2", CAmount(1 * COIN), 1, 1, DecodeAssetData("QmacSRmrkVmvJfbCpmU6pK72furJ8E8fbKHindrLxmYMQo"));
        ...
        CReissueAsset reissue6("ESSASSET2", CAmount(1 * COIN), 1, 1, DecodeAssetData("QmacSRmrkVmvJfbCpmU6pK72furJ8E8fbKHindrLxmYMQo"));
