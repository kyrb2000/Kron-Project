...
BOOST_FIXTURE_TEST_SUITE(asset_tx_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(asset_tx_valid_test)
    {
        ...
        CAssetTransfer asset("KronTEST", 1000);
    ...
    BOOST_AUTO_TEST_CASE(asset_tx_not_valid_test)
    {
        ...
        // This should fail because 900 Kron doesn't have a destination
        CAssetTransfer assetTransfer("KronTEST", 100);
    ...
    BOOST_AUTO_TEST_CASE(asset_tx_valid_multiple_outs_test)
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            CAssetTransfer asset2("KronTEST", 100);
    ...
    BOOST_AUTO_TEST_CASE(asset_tx_multiple_assets_test)
    {
        ...
        CAssetTransfer asset2("KronTESTTEST", 1000);
        CScript scriptPubKey2 = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        asset2.ConstructTransaction(scriptPubKey2);

        CAssetTransfer asset3("KronTESTTESTTEST", 1000);
        ...
        {
            // Add the first asset
            CAssetTransfer outAsset("KronTEST", 100);
            ...
            CAssetTransfer outAsset2("KronTESTTEST", 100);
            ...
            // Add the third asset
            CAssetTransfer outAsset3("KronTESTTESTTEST", 100);
        ...
        // The inputs are spending 3000 Assets (1000 of each Kron, KronTEST, KronTESTTEST)
        // The outputs are spending 100 Assets to 10 destinations (10 * 100 = 1000) (of each Kron, KronTEST, KronTESTTEST)
