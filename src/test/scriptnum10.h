...
#ifndef Kron_TEST_SCRIPTNUM10_H
#define Kron_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Kron Core 0.10.0, for cross-comparison.
 */
public:
