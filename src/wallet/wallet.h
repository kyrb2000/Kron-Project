...
#ifndef Kron_WALLET_WALLET_H
#define Kron_WALLET_WALLET_H
...
//! -fallbackfee default
static const CAmount DEFAULT_FALLBACK_FEE = 30025000;
...
public:
     ...
     * on this Kron node, and set to 0 for transactions that were created
...
public:
    ...
    void AvailableCoinsAll(std::vector<COutput>& vCoins, std::map<std::string, std::vector<COutput> >& mapAssetCoins,
                            bool fGetESS = true, bool fOnlyAssets = false,
    ...
    /**
     * Helper function that calls AvailableCoinsAll, used to receive all coins, Assets and ESS
     */
