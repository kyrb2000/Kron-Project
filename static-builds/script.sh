...
find ${DISTNAME}/bin -type f -executable -exec ../Kron/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../Kron/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/Kron/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/Kron/depends/SDKs/MacOSX10.11.sdk.tar.gz
