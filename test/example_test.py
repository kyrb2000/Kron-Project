...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the KronTestFramework
    pass

class ExampleTest(KronTestFramework):
    # Each functional test is a subclass of the KronTestFramework class.
    ...
    def custom_method(self):
        ...
        KronTestFramework class so other tests can use it."""
