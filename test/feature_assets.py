...
class AssetTest(KronTestFramework):
    ...
    def big_test(self):
        ...
        n0.listassets(asset="Kron*", verbose=False, count=2, start=-2)
        ...
        Kron_assets = n0.listassets(asset="Kron*", verbose=False, count=2, start=-2)
        assert_equal(len(Kron_assets), 2)
        assert_equal(Kron_assets[0], "Kron2")
        assert_equal(Kron_assets[1], "Kron3")
        self.sync_all()
