...
class RestrictedAssetsTest(KronTestFramework):
    ...
    def activate_restricted_assets(self):
        self.log.info("Generating ESS and activating restricted assets...")
        n0 = self.nodes[0]
        n0.generate(432)
        self.sync_all()
        n1 = self.nodes[1]
    ...
    def issuerestrictedasset(self):
        ...
        assert_raises_rpc_error(None, "Invalid Kron address", n0.issuerestrictedasset, asset_name, qty, verifier, "garbageaddress")
    ...
    def issuerestrictedasset_full(self):
        ...
        # valid params
        assert_raises_rpc_error(None, "Invalid Kron address", n0.issuerestrictedasset, asset_name, qty, verifier, to_address, "garbagechangeaddress")
    ...
    def reissuerestrictedasset_full(self):
        ...
        assert_raises_rpc_error(None, "Invalid Kron address", n0.reissuerestrictedasset, asset_name, qty, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid Kron address", n0.reissuerestrictedasset, asset_name, qty, to_address, change_verifier, verifier, "garbagechangeaddress")
    ...
    def issue_qualifier_asset_full(self):
        ...
        assert_raises_rpc_error(None, "Invalid Kron address", n0.issuequalifierasset, asset_name, qty, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid Kron address", n0.issuequalifierasset, asset_name, qty, to_address, "gargabechangeaddress")
    ...
    def transferqualifier(self):
        ...
        assert_raises_rpc_error(None, "Invalid Kron address", n0.transferqualifier, asset_name, 1, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid Kron address", n0.transferqualifier, asset_name, 1, n1_address, "garbagechangeaddress")
    ...
    def tagging(self):
        ...
        assert_raises_rpc_error(None, "Invalid Kron address", n0.addtagtoaddress, tag, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid Kron change address", n0.addtagtoaddress, tag, address, "garbagechangeaddress")
        ...
        assert_raises_rpc_error(None, "Invalid Kron address", n0.removetagfromaddress, tag, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid Kron change address", n0.removetagfromaddress, tag, address, "garbagechangeaddress")
    ...
    def freezing(self):
        ...
        assert_raises_rpc_error(None, "Invalid Kron address", n0.freezeaddress, asset_name, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid Kron change address", n0.freezeaddress, asset_name, address, "garbagechangeaddress")
        ...
        assert_raises_rpc_error(None, "Invalid Kron address", n0.unfreezeaddress, asset_name, "garbageaddress")
        assert_raises_rpc_error(None, "Invalid Kron change address", n0.unfreezeaddress, asset_name, address, "garbagechangeaddress")
    ...
    def global_freezing(self):
        ...
        assert_raises_rpc_error(None, "Invalid Kron change address", n0.freezerestrictedasset, asset_name, "garbagechangeaddress")
        ...
        assert_raises_rpc_error(None, "Invalid Kron change address", n0.unfreezerestrictedasset, asset_name, "garbagechangeaddress")
