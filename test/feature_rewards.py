...
class RewardsTest(KronTestFramework):
    ...
    def activate_assets(self):
        self.log.info("Generating ESS for node[0] and activating assets...")
    ...
    # Basic functionality test - ESS reward
    # - create the main owner address
    # - mine blocks to have enough ESS for the reward payments, plus purchasing the asset
    ...
    # - distribute an ESS reward amongst the shareholders
    # - verify that each one receives the expected amount of reward ESS
    def basic_test_rvn(self):
        self.log.info("Running basic ESS reward test!")
        n0, n1, n2 = self.nodes[0], self.nodes[1], self.nodes[2]
        ...
        n0.distributereward(asset_name="STOCK1", snapshot_height=tgt_block_height, distribution_asset_name="ESS",
        ...
        self.log.info("Verifying ESS holdings after payout")
    ...
    # - create the main owner address
    # - mine blocks to have enough ESS for the reward fees, plus purchasing the asset
    ...
    def payout_without_snapshot(self):
        ...
        assert_raises_rpc_error(-32600, "Snapshot request not found",
                                n0.distributereward, "STOCK3", tgt_block_height, "ESS", 2000, owner_addr0)
    ...
    def payout_with_invalid_ownership_asset(self):
        ...
        assert_raises_rpc_error(-32600, "The asset hasn't been created: STOCK4",
                                n0.distributereward, "STOCK4", tgt_block_height, "ESS", 2000, owner_addr0)
    ...
    def payout_before_minimum_height_is_reached(self):
        ...
        assert_raises_rpc_error(-32600,
                                ...
                                n0.distributereward, "STOCK6", tgt_block_height, "ESS", 2000, owner_addr0)
    ...
    def payout_custom_height_set_with_low_funds(self):
        ...
        n1.distributereward("STOCK7", tgt_block_height, "ESS", 2000, owner_addr0)

        n1.generate(2)
        self.sync_all()

        assert_equal(n1.getdistributestatus("STOCK7", tgt_block_height, "ESS", 2000, owner_addr0)['Status'], 3)
