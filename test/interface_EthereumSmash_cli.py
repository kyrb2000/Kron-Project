...
class TestKronCli(KronTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `Kron-cli getinfo`")
        ...
        self.log.info("Compare responses from `Kron-cli -getinfo` and the RPCs data is retrieved from.")
