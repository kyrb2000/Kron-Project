...
import os
import struct
from test_framework.test_framework import KronTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(KronTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that Kron has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("Krond has not been built with zmq enabled.")
