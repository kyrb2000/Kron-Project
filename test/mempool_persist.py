...
By default, Krond will dump mempool on shutdown and
...
class MempoolPersistTest(KronTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give Krond a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent Krond from writing mempool.dat to disk. Verify that `savemempool` fails")
