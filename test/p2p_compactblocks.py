...
# TestNode: A peer we use to send messages to Krond, and store responses.
...
class CompactBlocksTest(KronTestFramework):
    ...
    # This test actually causes Krond to (reasonably!) disconnect us, so do this last.
    ...
    # Test that Krond requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for Krond to be smart enough to know we're
