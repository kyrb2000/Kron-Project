...
class DecodeScriptTest(KronTestFramework):
    ...
    def decodescript_assets(self):
        """Test decoding ESS_ASSETS scripts (regtest scripts)."""
        ...
        assert_equal('OP_DUP OP_HASH160 35a8d9b395f1594e2cf3e06e6ec357d1da897368 OP_EQUALVERIFY OP_CHECKSIG OP_ESS_ASSET 1a72766e710954455354415353455400e40b54020000000800000075', result['asm'])
