...
class RawTransactionsTest(KronTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "changeAddress must be a valid Kron address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
