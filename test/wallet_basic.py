...
class WalletTest(KronTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 ESS from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 ESS with subtract fee from amount
        ...
        # Sendmany 10 ESS with subtract fee from amount
